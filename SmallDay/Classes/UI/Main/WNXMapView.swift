...
class WNXMapView: MKMapView {
    var flags: [MKPointAnnotation] = [MKPointAnnotation]()
    var lastMKAnnotationView: MKAnnotationView?
...
extension WNXMapView: MKMapViewDelegate {
...
*/
    ...
    func mapView(mapView: MKMapView!, didSelectAnnotationView view: MKAnnotationView!) {
        lastMKAnnotationView?.image = UIImage(named: "zuobiao1")
        view.image = UIImage(named: "zuobiao2")
        lastMKAnnotationView = view
    ...
    private func annotationViewForIndex(annot: MKAnnotationView) -> Int {
